...
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { led[3] }]; #IO_L24N_T3_35 Sch=led[4]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { led[2] }]; #IO_L24N_T3_35 Sch=led[4]
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { led[1] }]; #IO_L24N_T3_35 Sch=led[4]
set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { led[0] }]; #IO_L24N_T3_35 Sch=led[4]

## UART
set_property -dict { PACKAGE_PIN A9     IOSTANDARD LVCMOS33 } [get_ports {uart_rxd}]; # JD4
set_property -dict { PACKAGE_PIN D10    IOSTANDARD LVCMOS33 } [get_ports {uart_txd}]; # JD3
